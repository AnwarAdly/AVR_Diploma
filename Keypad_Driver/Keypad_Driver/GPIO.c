...
void vGPIO_Init_OP_Port(PortName_t PortName , uint8 Data){
	switch(PortName){
...
void vGPIO_Write_Port(PortName_t PortName ,uint8 Data){
	switch (PortName){
...
uint8 u8GPIO_Read_Port(PortName_t PortName ){
	uint8 x;
	switch (PortName){
...
void vGPIO_Init_OP_Pin(PortName_t PortName , PinNumber_t PinNumber , uint8 Data){
	switch (Data){
...
void vGPIO_Write_Pin(PortName_t PortName ,PinNumber_t PinNumber ,uint8 Data){
	switch (Data){
		case OFF : switch (PortName){
...
uint8 u8GPIO_Read_Pin(PortName_t PortName ,PinNumber_t PinNumber ){
	uint8 x;
	switch (PortName){
