...
void vGPIO_Init_OP_Port (PortName_t ,uint8_t );
void vGPIO_Init_IP_Port (PortName_t ,Pull_Status_t );
void vGPIO_Write_Port (PortName_t , uint8_t );
uint8_t u8GPIO_Read_Port (PortName_t  );
void vGPIO_Toggle_Port (PortName_t );
void vGPIO_Init_OP_Pin (PortName_t , PinNumber_t , uint8_t );
void vGPIO_Init_IP_Pin (PortName_t ,PinNumber_t , Pull_Status_t );
void vGPIO_Write_Pin (PortName_t ,PinNumber_t ,uint8_t );
uint8_t u8GPIO_Read_Pin (PortName_t ,PinNumber_t );
